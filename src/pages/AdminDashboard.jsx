...
//                         <div
//                             key={p._id}
//                             className="border rounded-lg shadow-sm bg-white p-4 flex flex-col hover:shadow-md transition"
//                         >
//                             <img
...
//                         <h3 className="text-lg font-semibold mb-4">✏️ Edit Product</h3>
...
//                                                     try {
//                                                         console.log("🟢 Deleting image:", img.url); // log what you're sending

//                                                         const res = await api.delete(`/api/admin/products/${editing._id}/images`, {
//                                                             data: { url: img.url },
//                                                         });
...
//                                                         const updated = refreshed.data.find((p) => p._id === editing._id);
//                                                         setEditing(updated);
//                                                     } catch (err) {
